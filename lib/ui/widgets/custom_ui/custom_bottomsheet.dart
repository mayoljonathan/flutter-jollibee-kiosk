...
///    sheets can be created and displayed with the [showModalBottomSheetFix]
///    function.
///
/// The [BottomSheet] widget itself is rarely used directly. Instead, prefer to
/// create a persistent bottom sheet with [ScaffoldState.showBottomSheet] or
/// [Scaffold.bottomSheet], and a modal bottom sheet with [showModalBottomSheetFix].
///
/// See also:
///
///  * [showBottomSheet] and [ScaffoldState.showBottomSheet], for showing
///    non-modal "persistent" bottom sheets.
///  * [showModalBottomSheetFix], which can be used to display a modal bottom
///    sheet.
...
class BottomSheet extends StatefulWidget {
  ...
  /// [showModalBottomSheetFix], for modal bottom sheets.
  const BottomSheet({
    Key key,
...
///    passed as the `builder` argument to [showModalBottomSheetFix].
///  * [showBottomSheet] and [ScaffoldState.showBottomSheet], for showing
///    non-modal bottom sheets.
///  * <https://material.io/design/components/sheets-bottom.html#modal-bottom-sheet>
Future<T> showModalBottomSheetFix<T>({
...
/// [showModalBottomSheetFix] function.
///
